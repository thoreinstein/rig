...
func TestIsNilInterface(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "typed-nil map", v: (map[string]int)(nil), want: true},
		{name: "typed-nil slice", v: ([]int)(nil), want: true},
		{name: "typed-nil func", v: (func())(nil), want: true},
		{name: "typed-nil chan", v: (chan int)(nil), want: true},
		...
		{name: "non-nil slice", v: []int{}, want: false},
